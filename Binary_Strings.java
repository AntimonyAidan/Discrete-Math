...
public class Binary_Strings
{
    ...
    public static String[] createBinaryNumbersStringArray(int n)
    {
        ...
        for(long i = 0; i < Math.pow(2,n); i++)
        {
            ...
            long x = i;  //initialize value to be compared at each digit place of the binary number                                      
            for(long z = (int)Math.pow(2,n-1); z > 0; z /= 2)
            {                
            ...
            arr[(int)i] = new String(tempCharArr);   //converts to String and assigns each character array to a new memory location in the string array         
        }
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("Given 'n', this program will give the number of binary strings\n"
                            + "of 'n' length that do not contain an input substring. (Current max 'n' is 21)\n\n\n"); 
        while(true) //loop structure to keep the program running until the user ends it
        {
            ...
            else if(n < 22)
            {
                ...
                System.out.println("Max 'n' is 21.");   //if n > 21, informs user, once again, that the max "n" is 21.
        }
    }        
}            